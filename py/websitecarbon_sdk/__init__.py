...
from websitecarbon_sdk.utility import register

# Load features
from websitecarbon_sdk.feature.base_feature import WebsiteCarbonBaseFeature
from websitecarbon_sdk.features import _has_feature, _make_feature
...
class WebsiteCarbonSDK:
    ...
    def get_utility(self):
        return WebsiteCarbonUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("WebsiteCarbonSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Data(self, data=None) -> "DataEntity":
        ...
        from websitecarbon_sdk.entity.data_entity import DataEntity
