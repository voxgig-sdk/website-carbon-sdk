# WebsiteCarbon Python SDK Reference

Complete API reference for the WebsiteCarbon Python SDK.
...
#### `WebsiteCarbonSDK.test(testopts=None, sdkopts=None)`
...
| `co2` | `dict` | Yes | Object containing data relating to CO2 emissions from each page load. |
...
```python
result = client.Data().load({"byte": 1, "green": 1})
```
