# WebsiteCarbon SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions WebsiteCarbonSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both WebsiteCarbonSDK(...) and WebsiteCarbonSDK.test(...) become
#      WebsiteCarbonSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "websitecarbon_sdk"
_SDK_CLASS = "WebsiteCarbonSDK"
