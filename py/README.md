# WebsiteCarbon Python SDK



The Python SDK for the WebsiteCarbon API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Data()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/website-carbon-sdk/releases)) or
...
| `co2` | `dict` | Object containing data relating to CO2 emissions from each page load. |
...
```
py/
├── websitecarbon_sdk.py         -- Main SDK module
