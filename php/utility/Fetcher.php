...
// WebsiteCarbon SDK utility: fetcher

class WebsiteCarbonFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; WebsiteCarbonSDK/1.0)';
    ...
    public static function call(WebsiteCarbonContext $ctx, string $fullurl, array $fetchdef): array
    {
