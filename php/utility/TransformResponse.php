...
// WebsiteCarbon SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class WebsiteCarbonTransformResponse
{
    public static function call(WebsiteCarbonContext $ctx): mixed
    {
        ...
        $transform = WebsiteCarbonHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
