...
// WebsiteCarbon SDK utility: make_options

class WebsiteCarbonMakeOptions
{
    ...
    public static function call(WebsiteCarbonContext $ctx): array
    {
        ...
        //
        // `WebsiteCarbonSchema::optspec()` is built from the model:
        ...
        $optspec = WebsiteCarbonSchema::optspec();
