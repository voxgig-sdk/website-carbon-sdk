...
// WebsiteCarbon SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (WebsiteCarbonSDK::test)
...
{
    private const SDK_CLASS = 'WebsiteCarbonSDK';
    ...
    private const SDK_BASE = 'websitecarbon_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../websitecarbon_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
