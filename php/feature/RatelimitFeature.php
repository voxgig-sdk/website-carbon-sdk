...
// WebsiteCarbon SDK ratelimit feature
...
class WebsiteCarbonRatelimitFeature extends WebsiteCarbonBaseFeature
{
    ...
    private function _acquire(WebsiteCarbonContext $ctx): void
    {
    ...
    private function _track(WebsiteCarbonContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
