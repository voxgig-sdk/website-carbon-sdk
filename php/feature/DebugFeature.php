...
// WebsiteCarbon SDK debug feature
...
class WebsiteCarbonDebugFeature extends WebsiteCarbonBaseFeature
{
    ...
    private function _finish(WebsiteCarbonContext $ctx, bool $ok): void
    {
