...
// WebsiteCarbon SDK telemetry feature
...
class WebsiteCarbonTelemetryFeature extends WebsiteCarbonBaseFeature
{
    ...
    private function _close(WebsiteCarbonContext $ctx, bool $ok): void
    {
