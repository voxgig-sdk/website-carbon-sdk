...
// WebsiteCarbon SDK netsim feature
...
class WebsiteCarbonNetsimFeature extends WebsiteCarbonBaseFeature
{
    ...
    private function _simulate(WebsiteCarbonContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(WebsiteCarbonContext $ctx, array $applied): void
    {
        $client = $this->client;
