...
// WebsiteCarbon SDK audit feature
...
class WebsiteCarbonAuditFeature extends WebsiteCarbonBaseFeature
{
    ...
    private function _emit(WebsiteCarbonContext $ctx, string $outcome): void
    {
