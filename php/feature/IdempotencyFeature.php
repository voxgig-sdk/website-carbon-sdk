...
// WebsiteCarbon SDK idempotency feature
...
class WebsiteCarbonIdempotencyFeature extends WebsiteCarbonBaseFeature
{
    ...
    private function _mutating(WebsiteCarbonContext $ctx): bool
    {
