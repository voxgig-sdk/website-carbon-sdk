...
// WebsiteCarbon SDK rbac feature
...
class WebsiteCarbonRbacFeature extends WebsiteCarbonBaseFeature
{
    ...
    private function _required(WebsiteCarbonContext $ctx): ?string
    {
    ...
    private function _reject(WebsiteCarbonContext $ctx, string $required): void
    {
    ...
    private function _track(WebsiteCarbonContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
