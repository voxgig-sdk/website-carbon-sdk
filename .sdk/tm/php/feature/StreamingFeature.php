...
// WebsiteCarbon SDK streaming feature
...
class WebsiteCarbonStreamingFeature extends WebsiteCarbonBaseFeature
{
    ...
    private function _iterate(WebsiteCarbonResult $result): \Generator
    {
    ...
    private function _streamable(WebsiteCarbonContext $ctx): bool
    {
