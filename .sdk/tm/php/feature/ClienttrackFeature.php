...
// WebsiteCarbon SDK clienttrack feature
...
class WebsiteCarbonClienttrackFeature extends WebsiteCarbonBaseFeature
{
    ...
    public function PostConstruct(WebsiteCarbonContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'WebsiteCarbon-SDK';
