...
// WebsiteCarbon SDK timeout feature
...
class WebsiteCarbonTimeoutFeature extends WebsiteCarbonBaseFeature
{
    ...
    private function _with_timeout(WebsiteCarbonContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(WebsiteCarbonContext $_ctx, float $ms): void
    {
        $client = $this->client;
