...
// WebsiteCarbon SDK cache feature
...
class WebsiteCarbonCacheFeature extends WebsiteCarbonBaseFeature
{
    ...
    private function _through(WebsiteCarbonContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
