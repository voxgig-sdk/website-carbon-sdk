...
// WebsiteCarbon SDK metrics feature
...
class WebsiteCarbonMetricsFeature extends WebsiteCarbonBaseFeature
{
    ...
    private function _record(WebsiteCarbonContext $ctx, bool $ok): void
    {
