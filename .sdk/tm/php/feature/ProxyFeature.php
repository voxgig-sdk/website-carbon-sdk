...
// WebsiteCarbon SDK proxy feature
...
class WebsiteCarbonProxyFeature extends WebsiteCarbonBaseFeature
{
    ...
    public function init(WebsiteCarbonContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (WebsiteCarbonContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
