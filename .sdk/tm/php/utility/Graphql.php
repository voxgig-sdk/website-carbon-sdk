...
// WebsiteCarbon SDK utility: graphql
//
...
class WebsiteCarbonGraphql
{
    ...
    // equivalent.
    public static function body(WebsiteCarbonContext $ctx): mixed
    {
    ...
    public static function errors(WebsiteCarbonContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
