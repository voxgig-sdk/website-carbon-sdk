...
// WebsiteCarbon SDK utility type

class WebsiteCarbonUtility
{
    ...
    public static function copy(WebsiteCarbonUtility $src): WebsiteCarbonUtility
    {
        $u = new WebsiteCarbonUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
