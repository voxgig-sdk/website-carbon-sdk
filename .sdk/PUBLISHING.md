...
|---|---|---|
| `ts/` | @voxgig-sdk/website-carbon-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/website-carbon-sdk \
      --repository voxgig-sdk/website-carbon-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/website-carbon-sdk` shows it, and
`npm trust revoke @voxgig-sdk/website-carbon-sdk --id=<id>` removes it.
