...
func registerSDKWords(r *eng.Registry, client *sdk.WebsiteCarbonSDK) {
...
func runOp(client *sdk.WebsiteCarbonSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
