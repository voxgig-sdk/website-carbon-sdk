...
AQL-driven CLI and REPL for the WebsiteCarbon SDK. Positional arguments are
...
./website-carbon-cli list data
./website-carbon-cli load 1 data
./website-carbon-cli load '{id:1}' data
