// Command WebsiteCarbon-cli is a CLI + REPL for the WebsiteCarbon SDK,
...
const prompt = "website-carbon"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "data"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      WEBSITE_CARBON_APIKEY (api key), WEBSITE_CARBON_BASE (base url override)")
...
func run(args []string, in io.Reader, out, errOut io.Writer) int {
	...
	// Configure from the environment: WEBSITE_CARBON_APIKEY carries the API key and
	// WEBSITE_CARBON_BASE optionally overrides the API base URL (e.g. production).
	// Both injectable by a secrets vault. Unset -> nil config defaults.
	var opts map[string]any
	if apikey := os.Getenv("WEBSITE_CARBON_APIKEY"); apikey != "" {
		opts = map[string]any{"apikey": apikey}
	}
	if base := os.Getenv("WEBSITE_CARBON_BASE"); base != "" {
		if opts == nil {
			opts = map[string]any{}
		}
		opts["base"] = base
	}
	client := sdk.NewWebsiteCarbonSDK(opts)
