...
#      offline in seeded test mode (WebsiteCarbonSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "WebsiteCarbon_sdk.rb")
  SDK_CLASS = "WebsiteCarbonSDK"
