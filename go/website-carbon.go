...
// instead of `sdk.NewWebsiteCarbonSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *WebsiteCarbonSDK  { return NewWebsiteCarbonSDK(nil) }
func Test() *WebsiteCarbonSDK { return TestSDK(nil, nil) }
