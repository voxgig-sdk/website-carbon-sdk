...
func TestDataEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		dataRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.data")))
...
func dataBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("WEBSITE_CARBON_TEST_DATA_ENTID")
	...
	idmapResolved := core.ToMapAny(env["WEBSITE_CARBON_TEST_DATA_ENTID"])
