...
(0, node_test_1.describe)('DataDirect', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('WEBSITE_CARBON_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.WebsiteCarbonSDK({
...
function liveScenariosActive() { return false && process.env.WEBSITE_CARBON_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.WebsiteCarbonSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['WEBSITE_CARBON_TEST_DATA_ENTID'];
    ...
    const client = new __1.WebsiteCarbonSDK({
        base: 'http://localhost:8080',
