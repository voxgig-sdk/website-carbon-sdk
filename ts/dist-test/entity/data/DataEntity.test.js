...
(0, node_test_1.describe)('DataEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.WebsiteCarbonSDK.test();
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != data_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    let client = __1.WebsiteCarbonSDK.test(options, extra);
    ...
    if (live) {
        ...
        client = new __1.WebsiteCarbonSDK(merge([
