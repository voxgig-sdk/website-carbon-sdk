...
function envOverride(m) {
    if ('TRUE' === process.env.WEBSITE_CARBON_TEST_LIVE ||
        'TRUE' === process.env.WEBSITE_CARBON_TEST_OVERRIDE) {
    ...
    m.WEBSITE_CARBON_TEST_EXPLAIN = process.env.WEBSITE_CARBON_TEST_EXPLAIN || m.WEBSITE_CARBON_TEST_EXPLAIN;
    return m;
}
