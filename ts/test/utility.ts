...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.WEBSITECARBON_TEST_LIVE ||
    'TRUE' === process.env.WEBSITECARBON_TEST_OVERRIDE
  ) {
  ...
  m.WEBSITECARBON_TEST_EXPLAIN = process.env.WEBSITECARBON_TEST_EXPLAIN || m.WEBSITECARBON_TEST_EXPLAIN
