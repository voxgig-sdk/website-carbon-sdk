...
Calculates website carbon emissions per page view using real-time tests.

Learn more about Website Carbon API at [www.websitecarbon.com](https://www.websitecarbon.com/).
