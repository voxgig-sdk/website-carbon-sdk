...
type Args struct {
	Entity string         `json:"entity" jsonschema:"data"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.WebsiteCarbonSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "website-carbon_list",
		Description: "List records from WebsiteCarbon. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "website-carbon_load",
		Description: "Load a single record from WebsiteCarbon. " +
...
func runOp(client *sdk.WebsiteCarbonSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.WebsiteCarbonSDK, name string) (sdk.WebsiteCarbonEntity, error) {
