// Command WebsiteCarbon-mcp is an MCP server exposing the WebsiteCarbon
// SDK as MCP tools.
//
// Two tools are registered:
//
//	WebsiteCarbon_list  — list records of an entity
//	WebsiteCarbon_load  — load a single record of an entity
//
